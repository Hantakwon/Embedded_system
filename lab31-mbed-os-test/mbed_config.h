...
#define MBED_CONF_APP_WIFI_PASSWORD                                           "silla1234"                                                                                       // set by application
#define MBED_CONF_APP_WIFI_SSID                                               "SILLA30"                                                                                           // set by application
...
#define MBED_CONF_ESP8266_DEBUG                                               1                                                                                                // set by library:esp8266
#define MBED_CONF_ESP8266_PROVIDE_DEFAULT                                     1                                                                                                // set by library:esp8266
